...
import SearchResultsCourseSections from "../components/SearchResultsCourseSections";
    ...
    <>
      ...
      <Container>
        <p className="mb-3 mt-5 text-center">
          Search for a Professor by their <b>Last Name</b> or <b>Last Name, First Initial</b>
        </p>
        ...
        <div id="searchbox" className="">
          ...
          {resultJSON && SearchResultsCourseSections(resultJSON)}
        </div>
      </Container>
    </>
  );
